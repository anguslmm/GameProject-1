...
namespace gp1::renderer::apis::vulkan::debug
{
	...
	void VulkanDebugRenderer::DebugBox([[maybe_unused]] const glm::fvec3& origin, [[maybe_unused]] const glm::fvec3& extents, [[maybe_unused]] const glm::fvec3& rotation, float duration, [[maybe_unused]] const glm::fvec4& color)
	{
	}
